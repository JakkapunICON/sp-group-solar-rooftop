...
import primebox from "@src/assets/images/menu/primebox.png";
import lotus from "@src/assets/images/menu/lotus.png";
...
const DefaultSwiper = () => {
  return (
    <ComponentContainerCard title="Prime box">
      ...
      <Swiper
        ...
        modules={[Autoplay]}>
        <SwiperSlide>
          <img src={primebox} alt="" height={50} />
        </SwiperSlide>
        <SwiperSlide>
          <img src={primebox} alt="" height={50} />
        </SwiperSlide>
      ...
      <label>Total of Plants : 1</label>|<label>Total of Capacity : 0.5 MWdc</label>
...
const NavigationNPaginationSwiper = () => {
  return (
    <ComponentContainerCard title="Lotus's">
      <div style={{ marginTop: "-5px" }}></div>
      <Swiper
        className="rounded default-swiper"
        autoplay={{ delay: 2000 }}
