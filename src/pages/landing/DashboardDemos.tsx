    ...
    <Box sx={{ py: "5rem", backgroundColor: "background.paper" }} id="dashboards">
      <ContainerBox>
        <SectionTitle
          ...
          description="Every chart or table you would need for statistical purpose, are already put there for you"
        />
        <Grid
          container
          spacing={4}
          ...
          <Grid item md={6}>
            <DemoCard link="/dashboards" image={dashboardEcom} name="E-Commerce" />
          </Grid>
