...
const componentRoutes = (): RouteObject => {
  return {
    path: "/",
    element: <PrivateRoute component={MenuLayout} />,
    children: [
      { path: "menu", element: <Component component={lazy(() => import("@src/pages/extended-ui/Swipers"))} /> },
    ],
  };
};
...
const otherRoutes = (): RouteObject => {
  return {
    ...
    children: [
      { path: "dashboards", element: <Component component={lazy(() => import("@src/pages/dashboard/ecommerce"))} /> },
      { path: "analytics", element: <Component component={lazy(() => import("@src/pages/dashboard/Analytics"))} /> },
      {
        path: "site/prime-box",
        element: <Component component={lazy(() => import("@src/pages/dashboard/SitePrimeBox"))} />,
      },
